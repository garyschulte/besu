...
public class ECRECK1PerfPrecompiledContract extends AbstractPrecompiledContract {
  ...
  public PrecompileContractResult computePrecompile(
    ...
    final Bytes safeInput = size >= 128 ? input : Bytes.wrap(input, MutableBytes.create(128 - size));
    ...
    try {
      final ECRecoverResult ecres = LibSecp256k1JNI.ecrecover(
      ...
      final Bytes32 hashed = Hash.keccak256(Bytes.wrap(ecres.publicKey));
