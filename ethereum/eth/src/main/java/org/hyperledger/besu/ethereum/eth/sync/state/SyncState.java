...
public class SyncState {
  ...
  private boolean isInSync(
    ...
    return isInitialSyncPhaseDone
        ...
        //        // Sync target may be temporarily empty while we switch sync targets during a
        // sync, so
        //        // check both the sync target and our best peer to determine if we're in sync or
        // not
